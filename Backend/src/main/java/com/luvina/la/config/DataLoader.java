...
@Component
/**
 * Lớp DataLoader dùng để khởi tạo dữ liệu ban đầu cho ứng dụng.
 * 
 * @author nxplong
 */
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (totalEmployees == 0) {
            ...
            // Tạo 4 nhân viên có cùng tên để kiểm tra sắp xếp
            // - Tên giống nhau: "Nguyễn Anh Thứ"
            // - 3 cấp độ tiếng Nhật khác nhau, với 2 nhân viên ở cấp độ 4
            // - 4 ngày kết thúc khác nhau
            ...
            // Thêm chứng chỉ cho nhân viên
            // Một số nhân viên có chứng chỉ, một số không
            ...
            // Chứng chỉ cho 4 nhân viên "Nguyễn Anh Thứ"
